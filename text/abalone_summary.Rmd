...
### Gravina data 
The traditional catch curve methods were performed using the Gravina data that has the ages determined from an age-length key of the Sheppard data.  These yielded a Z estimate ranging from 0.51 to 0.49.  This appears high for the life history of abalone. 

Catch curve results:

```{r grv regression, include=TRUE, echo = FALSE}
...
```{r grv Wtd regression, include=TRUE, echo = FALSE}
...
```{r grv chapman robson method, include=TRUE, echo = FALSE}
grvccW <- catchCurve(n~age, data = grvab.sumlen, ages2use = 2:12, use.weights = TRUE)
grvccW1 <- catchCurve(n~age, data = grvab.sumlen, ages2use = 2:10, use.weights = TRUE)
grvccW2 <- catchCurve(n~age, data = grvab.sumlen, ages2use = 3:12, use.weights = TRUE)
grvccW3 <- catchCurve(n~age, data = grvab.sumlen, ages2use = 3:10, use.weights = TRUE)
